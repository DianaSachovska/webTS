...
export class UIRenderer {
     ...
     * Render date headers
     */
    static renderDateHeaders(dates) {
        const container = document.getElementById('dateHeaders');
     ...
     */
    static renderCalendarGrid(habits, habitEntries, dates) {
     ...
     */
    static updateStats(habits, habitEntries) {
        const today = Utils.formatDate(new Date());
        const totalHabits = habits.length;
        const completedToday = habitEntries.filter(entry => entry.date === today && entry.completed).length;
